...
- README now documents connecting to a self-hosted Stihia instance via the `base_url` parameter.
- Updated README navigation instructions to reflect the new **Your Profile → Organization** menu path.
